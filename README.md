...
see the `Cargo.toml` file. At the moment it uses `llvm-22` as the default feature/llvm version.

Under the hood, this crate downloads LLVM binaries from a remote source at build time.
By default from [llvm-builds](https://github.com/RafalSzefler/llvm-builds/releases/tag/core) repository.
